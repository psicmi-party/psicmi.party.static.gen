...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      {
        text: 'how-to',
        link: '/how-to/', //目录页链接，此处link是vdoing主题新增的配置项，有二级导航时，可以点击一级导航跳到目录页
      },
      {
        text: 'repos',
        link: '/repos/',
  ...
  head: [
    ...
    [
      ...
      {
        name: 'keywords',
        content: 'psicmi,psicmi-party,psicmi.party,github,markdown',
      },
    ],
  ...
  plugins: <UserPlugins>[
    ...
    [
      'vuepress-plugin-comment', // 评论
      {
        choosen: 'gitalk',
        options: {
          clientID: '2ee94d1205c6d594dbe5',
          clientSecret: 'bc3d3b19c495435734a90244c742e4a05278a1a0',
          repo: 'psicmi-party-gittalk', // GitHub 仓库
          owner: 'psicmi', // GitHub仓库所有者
